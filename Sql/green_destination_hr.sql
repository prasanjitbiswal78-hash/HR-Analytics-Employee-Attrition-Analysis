...
CREATE TABLE `employees` (
  ...
  `DailyRate` int(4) DEFAULT NULL,
  `Department` varchar(22) DEFAULT NULL,
  `DistanceFromHome` int(2) DEFAULT NULL,
  `Education` int(1) DEFAULT NULL,
  `EducationField` varchar(16) DEFAULT NULL,
  `EmployeeCount` int(1) DEFAULT NULL,
  `EmployeeNumber` int(4) DEFAULT NULL,
  `EnvironmentSatisfaction` int(1) DEFAULT NULL,
  `Gender` varchar(6) DEFAULT NULL,
  `HourlyRate` int(3) DEFAULT NULL,
  `JobInvolvement` int(1) DEFAULT NULL,
  `JobLevel` int(1) DEFAULT NULL,
  `JobRole` varchar(25) DEFAULT NULL,
  `JobSatisfaction` int(1) DEFAULT NULL,
  `MaritalStatus` varchar(8) DEFAULT NULL,
  `MonthlyIncome` int(5) DEFAULT NULL,
  `MonthlyRate` int(5) DEFAULT NULL,
  `NumCompaniesWorked` int(1) DEFAULT NULL,
  `Over18` varchar(1) DEFAULT NULL,
  `OverTime` varchar(3) DEFAULT NULL,
  `PercentSalaryHike` int(2) DEFAULT NULL,
  `PerformanceRating` int(1) DEFAULT NULL,
  `RelationshipSatisfaction` int(1) DEFAULT NULL,
  `StandardHours` int(2) DEFAULT NULL,
  `StockOptionLevel` int(1) DEFAULT NULL,
  `TotalWorkingYears` int(2) DEFAULT NULL,
  `TrainingTimesLastYear` int(1) DEFAULT NULL,
  `WorkLifeBalance` int(1) DEFAULT NULL,
  `YearsAtCompany` int(2) DEFAULT NULL,
  `YearsInCurrentRole` int(2) DEFAULT NULL,
  `YearsSinceLastPromotion` int(2) DEFAULT NULL,
  `YearsWithCurrManager` int(2) DEFAULT NULL
...
INSERT INTO `employees` (`Age`, `Attrition`, `BusinessTravel`, `DailyRate`, `Department`, `DistanceFromHome`, `Education`, `EducationField`, `EmployeeCount`, `EmployeeNumber`, `EnvironmentSatisfaction`, `Gender`, `HourlyRate`, `JobInvolvement`, `JobLevel`, `JobRole`, `JobSatisfaction`, `MaritalStatus`, `MonthlyIncome`, `MonthlyRate`, `NumCompaniesWorked`, `Over18`, `OverTime`, `PercentSalaryHike`, `PerformanceRating`, `RelationshipSatisfaction`, `StandardHours`, `StockOptionLevel`, `TotalWorkingYears`, `TrainingTimesLastYear`, `WorkLifeBalance`, `YearsAtCompany`, `YearsInCurrentRole`, `YearsSinceLastPromotion`, `YearsWithCurrManager`) VALUES
...
--
-- Stand-in structure for view `employee_attrition_summary`
-- (See below for the actual view)
--
CREATE TABLE `employee_attrition_summary` (
...
--
-- Structure for view `employee_attrition_summary`
--
DROP TABLE IF EXISTS `employee_attrition_summary`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `employee_attrition_summary`  AS SELECT `employees`.`Department` AS `Department`, `employees`.`JobRole` AS `JobRole`, `employees`.`OverTime` AS `OverTime`, `employees`.`WorkLifeBalance` AS `WorkLifeBalance`, `employees`.`MonthlyIncome` AS `MonthlyIncome`, `employees`.`Attrition` AS `Attrition` FROM `employees` ;
COMMIT;
